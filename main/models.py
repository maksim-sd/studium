...
class Balance(models.Model):
    ...
    number_points = models.IntegerField(min=0, verbose_name="Количество баллов")
...
class Product(models.Model):
    ...
    price = models.IntegerField(min=0, verbose_name="Цена")
...
class Chat(models.Model):
    ...
    def __str__(self):
        return self.datetime_creation + " " + self.chat_status.name
...
class Task(models.Model):
    ...
    amount_reward = models.IntegerField(min=0, verbose_name="Сумма вознаграждения", null=True, blank=True)
    deadlines = models.ImageField(min=0, verbose_name="Сроки(количество дней)")
    datetime_creation = models.DateTimeField(auto_now=True, verbose_name="Дата и время создания")
    datetime_completion = models.DateTimeField(verbose_name="Дата и время завершения")
    chat = models.ForeignKey(Chat, on_delete=models.CASCADE, verbose_name="Чат")
...
class Feedback(models.Model):
    ...
    number_stars = models.IntegerField(min=0, max=5, verbose_name="Количество звезд")
